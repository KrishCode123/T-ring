      ...
      >
        {message.messageType === MESSAGE_TYPES.TEXT && (
          ...
          className={`${
            message.sender !== selectedChatData._id
              ? "bg-[#e1eaff] text-[#1a1a2e] border-[#cfd9e6]"
              : "bg-[#2f3136] text-[#d3d3d3] border-[#40444b]"
        ...
        {message.messageType === MESSAGE_TYPES.FILE && (
          <div
            className={`${
              message.sender !== selectedChatData._id
                ? "bg-[#ffffff] text-[#000000] border-[#000000]/50"
      ...
      >
          ...
          <div
            className={`${
              message.sender._id === userInfo.id
                ? "bg-[#ffffff9a] text-[#000000] border-[#000000]/50"
                : "bg-[#2a2b33]/50 text-white/80 border-[#ffffff]/20"
        ...
        {message.messageType === MESSAGE_TYPES.FILE && (
          <div
            className={`${
              message.sender._id === userInfo.id
                ? "bg-[#ffffff] text-[#ffffff]/90 border-[#ffffff]/50"
                : "bg-[#2a2b33]/50 text-white/80 border-[#ffffff]/20"
