...
const MessageBar = () => {
  ...
  const handleSendMessage = async () => {
    // Agar message blank hai, to kuch nahi hoga
    if (!message.trim()) {
      return;
    }
...
/>
      ...
      <button
        className="bg-blue-500 rounded-md flex items-center justify-center p-5 gap-2 focus:border-none focus:outline-none hover:bg-blue-700 focus:bg-bg-blue-700 transition-all duration-300 "
